...
class VerifierConfig:
    ...
    max_tokens: int = 200
    timeout: int = 60
    # Ollama keep_alive for the generator model (settings.yaml: llm.keep_alive).
    # "30m" keeps the SLM resident between queries so an interactive/demo
    # session does not pay the cold model reload after Ollama's ~5 min default
    # idle-unload. Residency only — never affects generated tokens.
    keep_alive: str = "30m"
